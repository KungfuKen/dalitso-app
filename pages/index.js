        ...
        <div className="px-6 md:px-16 pt-28 md:pt-12">
          ...
          <div className="text-left p-4 md:p-16">
            ...
            <div className="flex md:items-center justify-center md:flex-row flex-col">
              ...
              <div className="md:w-2/3 md:pt-0 pt-2">
                ...
                <p className="text-gray-200 font-mono text-sm md:pt-0 pt-2">
                  ...
                  My background is in electrical power and electronic communication systems. On this website, I write technical analysis focused on clean energy 
			...
			<div className="flex items-stretch justify-center mt-5 md:flex-row flex-col">
			  ...
			  <div href="" className="rounded-3xl md:w-1/2 flex flex-col h-100 hover:scale-[1.02]  transition-all duration-300">              
